import type { TollPlaza } from "../backend.d.ts";
...
export const TOLL_PLAZAS_DATA = [
  // ─── NH-48 / Chennai–Bengaluru corridor ───────────────────────────────────
  {
    ...
    latitude: 12.9056,
    longitude: 78.9517,
    tollRates: { carJeepVan: 75, lcv: 120, busTruck: 250, multiAxle: 355, mav: 530, oversized: 605 },
  },
  {
    id: "TN002",
    ...
    latitude: 12.2883,
    longitude: 78.8285,
    tollRates: { carJeepVan: 70, lcv: 115, busTruck: 240, multiAxle: 340, mav: 510, oversized: 580 },
  },
  {
    id: "TN003",
    ...
    latitude: 12.5446,
    longitude: 78.2013,
    tollRates: { carJeepVan: 80, lcv: 130, busTruck: 260, multiAxle: 365, mav: 545, oversized: 620 },
  },
  {
    id: "TN004",
    ...
    latitude: 12.4011,
    longitude: 78.3922,
    tollRates: { carJeepVan: 65, lcv: 105, busTruck: 220, multiAxle: 310, mav: 465, oversized: 530 },
  },
  {
    id: "TN005",
  ...
  },
  {
    ...
    latitude: 12.9819,
    longitude: 79.9691,
    tollRates: { carJeepVan: 90, lcv: 145, busTruck: 300, multiAxle: 425, mav: 640, oversized: 730 },
  },
  ...
  },
  {
    ...
    latitude: 12.2536,
    longitude: 79.4665,
    tollRates: { carJeepVan: 70, lcv: 110, busTruck: 235, multiAxle: 330, mav: 495, oversized: 565 },
  },
  {
    id: "TN011",
  ...
  },
  {
    ...
    latitude: 10.7905,
    longitude: 78.7047,
    tollRates: { carJeepVan: 85, lcv: 135, busTruck: 280, multiAxle: 395, mav: 595, oversized: 675 },
  },
  {
    id: "TN016",
...
const VEHICLE_RATE_KEY: Record<VehicleTypeKey, keyof typeof TOLL_PLAZAS_DATA[0]["tollRates"]> = {
...
export function getTollRate(
  plaza: { tollRates: { carJeepVan: number | bigint; lcv: number | bigint; busTruck: number | bigint; multiAxle: number | bigint; mav: number | bigint; oversized: number | bigint } },
  vehicleType: string
): number {
...
export function toBackendTollPlaza(p: typeof TOLL_PLAZAS_DATA[number]): TollPlaza {
  return {
    id: p.id,
    name: p.name,
    highway: p.highway,
